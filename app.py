...
model = pickle.load(open(r'C:\Users\DELL\Desktop\VS_code\Machine learning\linear_regression_model.pkl', 'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience built by priyanka.")
